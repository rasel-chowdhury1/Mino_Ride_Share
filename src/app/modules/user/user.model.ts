...
interface IUserStaticMethods extends Model<TUserCreate> {
  isUserExist(email: string): Promise<TUserCreate | null>;
  isUserActive(email: string): Promise<TUserCreate | null>;
  IsUserExistById(id: string): Promise<TUserCreate | null>;
...
export const User = model<TUserCreate, IUserStaticMethods>('User', userSchema);
